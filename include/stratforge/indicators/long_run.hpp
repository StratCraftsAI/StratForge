...
/// Long Run: count of consecutive bars where fast > slow.
class LongRun : public Indicator<LongRun> {
public:
    LongRun(const Line<double>& fast, const Line<double>& slow, std::size_t period = 2uz)
