...
/// CntN: fraction of bars in the trailing window where close < previous close.
/// Alpha158 formula: Mean($close < Ref($close,1), N)
class CntN : public Indicator<CntN> {
public:
    explicit CntN(const Line<double>& source, std::size_t period)
